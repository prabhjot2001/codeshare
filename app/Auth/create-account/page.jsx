...
import { Key, Mail, Eye, KeyRound, EyeOff, Lock } from 'lucide-react';
        ...
        <div className='flex items-center justify-center w-full min-h-screen'>
                <div className='flex border-4 border-neutral-100 gap-6 items-center justify-center p-6 rounded-md'>
                    ...
                    <div className='w-1/2 h-full'>
                        ...
                        <p className={styles.para}>Already have an account? <Link href={"/Auth/login"} className='hover:underline'>Login here</Link></p>
                    </div>
                </div>
            </div>
    )
